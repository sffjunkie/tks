...
class ColorWheel(ttk.Frame, object):
    ...
    def saturation(self, value):
        ...
        self._calc_sv_position(value, self._hsv[2])
    ...
    def value(self, value):
        ...
        self._calc_sv_position(self._hsv[1], value)
    ...
    def _sv_calc_from_position(self, x, y):
        ...
        if vx * (x - sx) + vy * (y - sy) < 0.0:
            s = 1.0
            v = (((x - sx) * (hx - sx) + (y - sy) * (hy-sy)) / ((hx - sx) * (hx - sx) + (hy - sy) * (hy - sy)))
            if v < 0.0:
                v = 0.0
            elif v > 1.0:
                v = 1.0
            ...
            s = 0.0
            v = (((x - sx) * (vx - sx) + (y - sy) * (vy - sy)) / ((vx - sx) * (vx - sx) + (vy - sy) * (vy - sy)))
            if v < 0.0:
                v = 0.0
            elif v > 1.0:
                v = 1.0
            ...
            v = 1.0
            s = (((x - vx) * (hx - vx) + (y - vy) * (hy - vy)) / ((hx - vx) * (hx - vx) + (hy - vy) * (hy - vy)))
            if s < 0.0:
                s = 0.0
            elif s > 1.0:
                s = 1.0
        else:
            v = (((x - sx) * (hy - vy) - (y - sy) * (hx - vx)) / ((vx - sx) * (hy - vy) - (vy - sy) * (hx - vx)))
            if v <= 0.0:
                v = 0.0
                s = 0.0
            else:

# -*- coding: utf-8 -*-
#
# tkStuff documentation build configuration file, created by
# sphinx-quickstart on Sat Jun 21 15:36:01 2014.
#
...
latex_documents = [
    ('index', 'tkStuff.tex', u'tkStuff Documentation',
...
man_pages = [
    ('index', 'tkstuff', u'tkStuff Documentation',
     [u'Simon Kennedy'], 1)
]
...
texinfo_documents = [
    ('index', 'tkStuff', u'tkStuff Documentation',
     u'Simon Kennedy', 'tkStuff', 'One line description of project.',
     'Miscellaneous'),
]
